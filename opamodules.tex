...
\ppro{
\unico{Pass\_CH\_Handles} and \unico{Pass\_LabPath\_Handles} receive handles to the 25 \guifco{CHamLine} instances and to the three pathlength labels in the \ogui{OPAChroma} GUI.
