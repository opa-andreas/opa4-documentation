...
\desc{This GUI is used to interactively optimize the field profile of a longitudinal gradient bend in order to minimize quantum excitation, i.e. the $I_5$ radiation integral. Magnet type, length, peak field and number of slices are set before starting a Powell minimizer. 
}
...
\desc{Physics procedures and plotting of longitudinal gradient bend optimization results.}
