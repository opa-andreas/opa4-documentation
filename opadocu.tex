...
\parbox[t]{0.7\hsize}{
  {\Huge\bf OPA documentation} version {\bf 4.2.4}\\
  Andreas Streun, \today
...
\evcodx{geo.p repaint}{geopPaint}: an \code{OnPaint} for the paintbox object \guifco{p} inside \guifco{geo} calls \guico{MakePlot} to update the plot. \todo{Probably the malfunction in the linux version is related to that~-- to be explored.}
